...
Original file is located at
    https://colab.research.google.com/drive/15UouzEsZbfkTUBOoIsJhwR6Teh27IHuz
"""
...
pkl_file = open('COLAB_fifth_checked.pkl', 'rb')
...
train_data=np.array(l_train)
labels=np.array(l_label)

Lateral_data = open('Lateral_data_no_CNN.pkl', 'wb')
pickle.dump(train_data,Lateral_data)
Lateral_data.close()

Lateral_labels = open('Lateral_labels_no_CNN.pkl', 'wb')
